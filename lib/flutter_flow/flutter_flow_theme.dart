...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF2962FF);
  late Color secondary = const Color(0xFF2962FF);
  late Color tertiary = const Color(0xFF0D47A1);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF1A2A3A);
  late Color secondaryText = const Color(0xFF444F5B);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFECECEC);
  late Color accent1 = const Color(0xFFE3F2FD);
  late Color accent2 = const Color(0xFF90CAF9);
  late Color accent3 = const Color(0xFF42A5F5);
  late Color accent4 = const Color(0xFF2962FF);
